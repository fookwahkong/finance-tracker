...
export default function AllocationDonut({ allocations, compact = false }) {
  ...
  const size = compact ? 110 : 240;
  const hole = compact ? 28 : 60;
  return (
    <div style={{
      display: "flex",
      ...
      <div style={{ display: "grid", gap: compact ? 6 : 10, width: compact ? "100%" : undefined }}>
        {allocations.map((a, i) => (
          <div key={a.ticker} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: compact ? 12 : 13 }}>
